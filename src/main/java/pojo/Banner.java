...
public class Banner {
	...
	public Banner(String bannerId, String bannerName, ZonedDateTime startDateTime, 
			ZonedDateTime endDateTime,List<InetAddress> permittedIP) {
		super();
	...
	private List<InetAddress> permittedIP;
	...
	public List<InetAddress> getPermittedIP() {
		return permittedIP;
	}

	public void setPermittedIP(List<InetAddress> permittedIP) {
		this.permittedIP = permittedIP;
	}
